...
Gaussian_Mixture_Model_Clustering <- function (sample_data, mu, Sigma, k, margin_of_error) {
  ...
  while(!convergence) { # To be replaced with convergence check
    ...
    error <- sum(abs(mu - prev_mu))/ k
    # print(paste("error = ", error))
    acceptable_error <- sum(abs(margin_of_error * prev_mu))/ k
    # print(paste("acceptable error = ", acceptable_error))
...
```{r}
result_summary <- Gaussian_Mixture_Model_Clustering(data, mu, Sigma, k, margin_of_error = 0.000000000005)
